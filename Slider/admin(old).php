<?php
    ...
    if(isset($_POST['add_customer'])){
        ...
        $query = mysqli_query($con, "INSERT INTO customers VALUES (NULL,'$username','$password','$email','$nohp','$fullname')");
        exit();
    }
    ...
    if(isset($_POST['show_airline'])){
        ...
        while($row=mysqli_fetch_array($query)){
            ...
            <a class="update updateAirline" title="Update" data-toggle="tooltip"><i class="material-icons">&#xE03B;</i></a>
            <a class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
            <a class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
            </td>
            </tr>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".add-Pesawat").click(function(){
                ...
                var row = '<tr>' +
                '<td><input type="text" class="form-control" name="kapasitas" id="kapasitas"></td>' +
                '<td><input type="text" class="form-control" name="idairlines" id="idairlines"></td>' +
                '<td><input type="text" class="form-control" name="kodepesawat" id="kodepesawat" disabled></td>' +
            ...
            $(".add-Debit").click(function(){
                ...
                '<td><input type="text" class="form-control" name="tgl" id="tgl"></td>' +
                '<td><input type="text" class="form-control" name="saldo" id="saldo"></td>' +
            ...
            $(".add-Kredit").click(function(){
                ...
                '<td><input type="text" class="form-control" name="namabank" id="namabank"></td>' +
                '<td><input type="text" class="form-control" name="tgl" id="tgl"></td>' +
                '<td><input type="text" class="form-control" name="tiga_digit" id="tiga_digit"></td>' +
                '<td><input type="text" class="form-control" name="tagihan" id="tagihan"></td>' +
            ...
            $(".add-Jadwal").click(function(){
                ...
                var row = '<tr>' +
                '<td><input type="text" class="form-control" name="tgl" id="tgl"></td>' +
                '<td><input type="text" class="form-control" name="jambrangkat" id="jambrangkat"></td>' +
                '<td><input type="text" class="form-control" name="jamtiba" id="jamtiba"></td>' +
