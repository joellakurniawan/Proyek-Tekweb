<?php
	...
	if(isset($_POST['showmaskapai'])){
		...
		JOIN pesawat p ON jp.id_pesawat = p.id_pesawat
		JOIN airlines a ON p.id_airlines = a.id_airlines
		WHERE jp.lokasi_awal =  '".$_SESSION['lokasitujuan']."'
		AND jp.lokasi_tujuan =  '".$_SESSION['lokasiawal']."'
		AND jp.tanggal_penerbangan = '".$_SESSION['tanggalpulang']."')
		OR id_airlines IN (SELECT a.id_airlines
		FROM jadwal_penerbangan jd1
		JOIN jadwal_penerbangan jd2
		JOIN pesawat p1 ON jd1.id_pesawat = p1.id_pesawat
		JOIN pesawat p2 ON jd2.id_pesawat = p2.id_pesawat
		JOIN airlines a ON p1.id_airlines = a.id_airlines
		WHERE jd1.lokasi_awal='".$_SESSION['lokasitujuan']."' 
		AND jd1.lokasi_tujuan=jd2.lokasi_awal 
		AND jd2.lokasi_tujuan='".$_SESSION['lokasiawal']."' 
		AND jd1.tanggal_penerbangan='".$_SESSION['tanggalpulang']."' 
		AND jd2.tanggal_penerbangan='".$_SESSION['tanggalpulang']."' 
		AND jd2.jam_berangkat>jd1.jam_tiba
		AND p1.id_airlines = p2.id_airlines)
		OR id_airlines IN (SELECT a.id_airlines
		FROM jadwal_penerbangan jd1
		...
		AND jd2.lokasi_tujuan =  '".$_SESSION['lokasiawal']."'
		AND jd1.tanggal_penerbangan =  '".$_SESSION['tanggalpulang']."'
		AND jd2.tanggal_penerbangan=DATE_ADD('".$_SESSION['tanggalpulang']."', INTERVAL 1 DAY)
		AND jd2.jam_berangkat<=jd1.jam_berangkat
		AND p1.id_airlines = p2.id_airlines)
		OR id_airlines IN (SELECT a.id_airlines
		FROM jadwal_penerbangan jd1
		...
		AND jd1.lokasi_tujuan = jd2.lokasi_awal
		AND jd3.lokasi_awal = jd2.lokasi_tujuan
		AND jd3.lokasi_tujuan =  '".$_SESSION['lokasiawal']."'
		AND jd1.tanggal_penerbangan =  '".$_SESSION['tanggalpulang']."'
		AND jd2.tanggal_penerbangan =  '".$_SESSION['tanggalpulang']."'
		AND jd3.tanggal_penerbangan =  '".$_SESSION['tanggalpulang']."'
		AND jd2.jam_berangkat > jd1.jam_tiba
		AND jd3.jam_berangkat > jd2.jam_tiba
		AND p1.id_airlines = p2.id_airlines
		AND p2.id_airlines = p3.id_airlines)
		...
		AND jd1.tanggal_penerbangan =  '".$_SESSION['tanggalpulang']."'
		AND jd2.tanggal_penerbangan =  '".$_SESSION['tanggalpulang']."'
		AND jd3.tanggal_penerbangan =  DATE_ADD('".$_SESSION['tanggalpulang']."', INTERVAL 1 DAY)
		AND jd2.jam_berangkat > jd1.jam_tiba
		AND jd3.jam_berangkat<=jd2.jam_tiba
		AND p1.id_airlines = p2.id_airlines
		AND p2.id_airlines = p3.id_airlines)
	...
	if(isset($_POST['showdataberangkat'])){
	...
	while($row=mysqli_fetch_array($result)){	
		...
		if($sisa>0){
			...
			while ($row=mysqli_fetch_array($result)){
				...
				<li class="pilih" style="width:20%;" data-val="'.$row['id_jdpenerbangan'].'" data-harga="'.$row['harga'].'"><a class="next-step" href="#menu2"><span class="fa fa-check-circle"></span></a></li>
				<li class="pilih" style="width:20%; visibility: hidden;"><a href="#pilih" disabled></a></li>
				</ul>
				</div>
				</li>';
	...
	while($row=mysqli_fetch_array($result)){
		...
		if($sisa1>0 && $sisa2>0){
			...
			while ($row=mysqli_fetch_array($result)){
				...
				<li class="pilih" style="width:20%;" data-val="'.$value.'" data-harga="'.$harga.'"><a class="next-step" href="#menu2"><span class="fa fa-check-circle"></span></a></li>
				<li class="pilih" style="width:20%; visibility: hidden;"><a href="#pilih" disabled></a></li>
				</ul>
				</div>
				</li>';
	...
	while($row=mysqli_fetch_array($result)){	
		...
		if($sisa>0){
			...
			while ($row=mysqli_fetch_array($result)){
				...
				<li class="pilih" style="width:20%;" data-val="'.$row['id_jdpenerbangan'].'" data-harga="'.$row['harga'].'"><a href="/Slider/pembayaran/indexrt.php"><span class="fa fa-check-circle"></span></a></li>
				<li class="pilih" style="width:20%; visibility: hidden;"><a href="#pilih" disabled></a></li>
				</ul>
				</div>
				</li>';
	...
	while($row=mysqli_fetch_array($result)){
		...
		if($sisa1>0 && $sisa2>0){
			...
			while ($row=mysqli_fetch_array($result)){
				...
				<li class="pilih" style="width:20%;" data-val="'.$value.'" data-harga="'.$harga.'"><a href="/Slider/pembayaran/indexrt.php"><span class="fa fa-check-circle"></span></a></li>
				<li class="pilih" style="width:20%; visibility: hidden;"><a href="#pilih" disabled></a></li>
				</ul>
				</div>
				</li>';
	...
	if(isset($_POST['pilihberangkat'])){
		$_SESSION['idjdpenerbanganberangkat'] = $_POST['idjdpenerbanganberangkat'];
		$_SESSION['hargatiketberangkat'] = $_POST['hargatiketberangkat'];
		$_SESSION['counter'] = 1;
		exit();
	}
	if(isset($_POST['pilihpulang'])){
		$_SESSION['idjdpenerbanganpulang'] = $_POST['idjdpenerbanganpulang'];
		$_SESSION['hargatiketpulang'] = $_POST['hargatiketpulang'];
		$_SESSION['counter'] = 1;
		exit();
	}
?>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$('.btn-circle').on('click',function(){
					...
					$(".tab-pane.fade.active.in").removeClass('active in show').hide();
					$(this).addClass('btn-info').removeClass('btn-default').blur();
					var a = $(this).attr('href');
					$(a).addClass("active in show");
				});
				$('.berangkat').on('click', '.next-step', function (e){
				...
				showdataberangkat();
				showdatapulang();
				$(".berangkat").on("click", ".pilih", function(){
					var a = $(this).data("val");
					...
					$.ajax({
						...
						data : {
							pilihberangkat : 1,
							idjdpenerbanganberangkat : a,
							hargatiketberangkat : b
						},
						success: function(result){
						}
					});
				});
				$(".pulang").on("click", ".pilih", function(){
					var a = $(this).data("val");
					var b = $(this).data("harga");
					$.ajax({
						url : "filterrt.php",
			...
			function showdataberangkat(){
				$.ajax({
					...
					success: function(result){
						$(".berangkat").html(result);
					}
				});
			}
			function showdatapulang(){
				$.ajax({
					url : "filterrt.php",
					type : "POST",
					async : false,
				...
				<div class="process">
					<div class="process-row nav nav-tabs">
						<div class="process-step">
							<button type="button" id="berangkat" class="btn btn-info btn-circle" data-toggle="tab" href="#menu1"><i class="fa fa-plane fa-3x"></i></button>
							<p><small>Pilih Tiket Berangkat</small></p>
						</div>
						<div class="process-step">
							<button type="button" id="pulang" class="btn btn-default btn-circle" data-toggle="tab" href="#menu2"><i class="fa fa-plane fa-3x"></i></button>
							<p><small>Pilih Tiket Pulang</small></p>
						</div>
					</div>
				</div>
